                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-20 border-b border-gray-100">
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="flex flex-col space-y-4">
                            <a href="tel:+919895044555" className="text-deep-navy hover:text-gold transition-colors text-[15px] font-medium">+91 98950 44555</a>
                            <a href="mailto:bayroofconstructions@gmail.com" className="text-deep-navy hover:text-gold transition-colors text-[15px] font-medium break-all">
                                bayroofconstructions@gmail.com
                            </a>
                        </div>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center py-10 space-y-8 md:space-y-0">
                    <div className="flex items-center space-x-8">
                        ...
                        <div className="flex space-x-5">
                            <Linkedin className="w-5 h-5 text-gray-400 hover:text-deep-navy cursor-pointer transition-colors" />
                            <Youtube className="w-5 h-5 text-gray-400 hover:text-deep-navy cursor-pointer transition-colors" />
                            <Instagram className="w-5 h-5 text-gray-400 hover:text-deep-navy cursor-pointer transition-colors" />
                            <Facebook className="w-5 h-5 text-gray-400 hover:text-deep-navy cursor-pointer transition-colors" />
                        </div>
                    </div>

                    <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
                        <Link href="#" className="text-gray-400 hover:text-deep-navy text-[13px] font-medium transition-colors">Privacy Policy</Link>
                        <Link href="#" className="text-gray-400 hover:text-deep-navy text-[13px] font-medium transition-colors">Cookie Policy</Link>
                        <Link href="#" className="text-gray-400 hover:text-deep-navy text-[13px] font-medium transition-colors">Terms and Conditions</Link>
                    </div>
                </div>
