...
<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control" style="height:150px" name="content"></textarea>
  ...
  <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="meta_key" class="form-control"  required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="meta_desc" class="form-control"   required>
                </div>
