                    ...
                    <tbody>
                        @forelse($service as $ser)
                            <tr>
                                ...
                                <td>{{ $ser->title }}</td>
                                <td>{{  Str::limit(strip_tags($ser->content), 100) }}</td>
                               <td><img src="{{asset('uploads/service/'.$ser->image)}}" alt="image"  width="150px" alt="No Image" style="background-color: #17a2b8;"></td>
                                <td>
