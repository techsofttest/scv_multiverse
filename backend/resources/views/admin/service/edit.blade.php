...
@method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <label for="" class="col-sm-2 col-form-label">Service Title</label>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control" style="height:150px" name="content">{!! $service->content !!}</textarea>
                ...
                <img src="{{ asset('uploads/service/') }}/{{ $service->image }}" width="150px" alt="No Image" style="background-color: #17a2b8;">
  ...
  <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="meta_title" class="form-control" value="{{$service->meta_title}}"  required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="meta_key" class="form-control" value="{{$service->meta_key}}"  required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="meta_desc" class="form-control" value="{{$service->meta_desc}}"  required>
                </div>
