...
@method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <label for="" class="col-sm-2 col-form-label">Banner Title</label>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control" style="height:150px" name="content">{!! $banner->content !!}</textarea>
                ...
                <img src="{{ asset('uploads/banner/') }}/{{ $banner->image }}" width="150px" alt="No Image" style="background-color: #17a2b8;">
                ...
                <label for="" class="col-sm-2 col-form-label"> Upload Image (1500 x 600) </label>
