...
<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <label for="" class="col-sm-2 col-form-label">Page Name</label>
            ...
            <label for="" class="col-sm-2 col-form-label">@if($page->type==3 || $page->type==4 || $page->type==5) Uploaded Icon @else Uploaded Image @endif </label>
                ...
                <label for="" class="col-sm-2 col-form-label">@if($page->type==3 || $page->type==4 || $page->type==5) Upload Icon (100 x 67) @else Upload Image (940 x 999) @endif   </label>
         ...
         @if(in_array($page->id, [2, 4]))
            ...
            <label for="" class="col-sm-2 col-form-label"> Uploaded Image</label>
                ...
                <img src="{{ asset('uploads/pages/more/') }}/{{ $page->image2 }}" width="150px" alt="No Image" style="background-color: #17a2b8;">
